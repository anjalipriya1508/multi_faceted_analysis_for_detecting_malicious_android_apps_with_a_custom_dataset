...
# ---------- Step 2: Manual Random Forest Implementation ----------
class DecisionTree:
    ...
    def predict_proba(self, X):
        return np.array([1 if self._predict_sample(sample, self.tree) == 1 else 0 for sample in X])
...
# ---------- Step 6: Plot ROC Curve Separately ----------
