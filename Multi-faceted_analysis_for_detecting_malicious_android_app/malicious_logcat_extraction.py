...
def process_logcat_folder(folder_path, output_csv):
    print("🚀 Started feature extraction from logcat files...")
    all_features = []
...
# Usage
folder_path = "malicious_apk_logcat_logs"  # Change this to your logcat files folder
output_csv = "androZoo_dataset_analysis/malicious_dynamic_features_extraction.csv"  # Desired output file
